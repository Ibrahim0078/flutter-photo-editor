...
class _StickerScreenState extends State<StickerScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Center(child: Consumer<AppImageProvider>(
          builder: (BuildContext context, value, Widget? child) {
        if (value.currentImage != null) {
          return LindiStickerWidget(
              controller: controller, child: Image.memory(value.currentImage!));
        }
        return const Center(
                          ...
                          children: [
                            SizedBox(
                              ...
                              child: FittedBox(
                                  ...
                                  child: InkWell(
                                      onTap: (){
                                        controller.addWidget(Image.asset(sticker, width: 100,));
                                      },
